        ...
        <div class="col-md-6 col-md-offset-3">
                <div class="box">
                        ...
                        <form action="" method="POST">
                                ...
                                <textarea rows="4" name="address" id="form-value"><?php echo $row['$address'];?></textarea> <br>
                                
                                <label for="contact"> Contact </label>
                                <input type="text" name="contact" id="contact" value="<?php echo $row['contact'];?>" class="form-contral"> <br>
